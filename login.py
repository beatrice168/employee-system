...
image= CTkImage(Image.open("backgroung.png"), size=(930, 478))
imageLabel=CTkLabel(root, image=image,text="") 
imageLabel.place(x=0, y=0)
headingLabel=CTkLabel(root, text="Employee Management System", bg_color="transparent", font= ("Arial", 20, "bold"),text_color="dark blue")
